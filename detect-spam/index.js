...
const { contractVerified, saveVerifiedCache } = require('./etherscan')
...
const SPAM_CUTOFF = 8
const OUTPUT_PATH = path.join(__dirname, `../hamelin-spam/out/${START_BLOCK}-${END_BLOCK}/`)
...
async function main () {
  const provider = new ethers.providers.JsonRpcProvider('https://mainnet.infura.io/v3/ea1b9498facd4198ac8da80bc151a045')
  const spamRates = []
